...
namespace WebApplication16.Controllers
{
    public class BlogController : Controller
    {
        ...
        public BlogController(WebApplication16Context context, IShortcodeService shortcodeService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(int page = 1)
        {
            ...
            var paginatedPosts = await PaginatedList<Models.Post>.CreateAsync(postsQuery.AsNoTracking(), page, pageSize);
        ...
        public async Task<IActionResult> Details(string slug)
        {
            ...
            post.Content = await _shortcodeService.ProcessShortcodesAsync(post.Content);
